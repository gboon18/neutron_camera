...
RunAction::RunAction()
{
  ...
  // Creating histograms
  analysisManager->CreateH1("col" ,"Edep in collimator", 100, 0., 10*keV);
  analysisManager->CreateH1("det1" ,"Edep in detector 1", 100, 0., 10*keV);
  analysisManager->CreateH1("det2" ,"Edep in detector 2", 100, 0., 10*keV);
  analysisManager->CreateH1("det3" ,"Edep in detector 3", 100, 0., 10*keV);
  analysisManager->CreateH1("det4" ,"Edep in detector 4", 100, 0., 10*keV);
  analysisManager->CreateH1("det5" ,"Edep in detector 5", 100, 0., 10*keV);
  analysisManager->CreateH1("det6" ,"Edep in detector 6", 100, 0., 10*keV);
  analysisManager->CreateH1("det7" ,"Edep in detector 7", 100, 0., 10*keV);
  analysisManager->CreateH1("det8" ,"Edep in detector 8", 100, 0., 10*keV);
  analysisManager->CreateH1("det9" ,"Edep in detector 9", 100, 0., 10*keV);
...
void RunAction::BeginOfRunAction(const G4Run*)
{
  ...
  // G4String fileName = "col_det.root";
